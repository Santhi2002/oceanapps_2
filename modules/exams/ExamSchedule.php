...
extract($_REQUEST);
$view_url="vw_examschedule.php";
$ctrl_url="ExamSchedule.php";
...
if(isset($_POST['initiate'])){
	...
	$theoryexamtime=$_POST['examsession'];
	$examtype=$_POST['examtype'];
	$examfromdate=$_POST['examfromdate'];
	$examtodate=$_POST['examtodate'];
	$feestartdate=$_POST['feefromdate'];
	$feeenddate=$_POST['feetodate'];
	$excludedates=$_POST['excludedates'];
	$examfee=$_POST['examfee'];
	$username= $_SESSION['email'];
	$result=$exam_handler->prepareExamSchedule($program,$regulation,$course ,$studyyear,$semester,$examtype,$examfromdate, $examtodate,$theoryexamtime,$examfee,$feestartdate,$feeenddate,$excludedates,$username);
	
	$msg = '<div class="alert alert-success alert-dismissible" role="alert">
			<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
				<div class="alert-message">
							<strong>Success!</strong> Time Tables are generated!
				</div>
			</div>';
