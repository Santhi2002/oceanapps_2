...
class X509
{
    ...
    public function validateDate($date = null)
    {
        ...
        if (!isset($date)) {
            $date = new DateTimeImmutable(null, new DateTimeZone(@date_default_timezone_set()));
        }
        ...
        if (is_string($date)) {
            $date = new DateTimeImmutable($date, new DateTimeZone(@date_default_timezone_set()));
        }

        $notBefore = new DateTimeImmutable($notBefore, new DateTimeZone(@date_default_timezone_set()));
        $notAfter = new DateTimeImmutable($notAfter, new DateTimeZone(@date_default_timezone_set()));
    ...
    public function sign($issuer, $subject)
    {
        ...
        if (isset($subject->currentCert) && is_array($subject->currentCert) && isset($subject->currentCert['tbsCertificate'])) {
            ...
            $startDate = new DateTimeImmutable('now', new DateTimeZone(@date_default_timezone_set()));
            $startDate = !empty($this->startDate) ? $this->startDate : $startDate->format('D, d M Y H:i:s O');

            $endDate = new DateTimeImmutable('+1 year', new DateTimeZone(@date_default_timezone_set()));
    ...
    public function signCRL($issuer, $crl)
    {
        ...
        $thisUpdate = new DateTimeImmutable('now', new DateTimeZone(@date_default_timezone_set()));
    ...
    private function revokedCertificate(&$rclist, $serial, $create = false)
    {
        ...
        $i = count($rclist);
        $revocationDate = new DateTimeImmutable('now', new DateTimeZone(@date_default_timezone_set()));
